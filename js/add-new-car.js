...
form.addEventListener("submit", async e => {
	e.preventDefault(); // ngăn chặn mặc định của trình duyệt
	await save(); // để lưu vào CSDL rồi mới nhập tiếp, await là hàm bất đồng bộ
	form.reset(); // để đặt lại về trạng thái ban đầu
});
